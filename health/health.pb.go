...
const (
	...
	HealthCheckResponse_SERVICE_UNKNOWN HealthCheckResponse_ServingStatus = 3 // never sent by servers; used by callers
)
...
type HealthCheckRequest struct {
	...
	Service       string                 `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"` // optional service name; ignored in 0.1.0
...
type HealthCheckResponse struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Status        HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=distribkv.health.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_health_proto_rawDesc = "" +
	"\n" +
	"\x12proto/health.proto\x12\x10distribkv.health\".\n" +
	"\x12HealthCheckRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\"\xb3\x01\n" +
	"\x13HealthCheckResponse\x12K\n" +
	"\x06status\x18\x01 \x01(\x0e23.distribkv.health.HealthCheckResponse.ServingStatusR\x06status\"O\n" +
	"\rServingStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSERVING\x10\x01\x12\x0f\n" +
	"\vNOT_SERVING\x10\x02\x12\x13\n" +
	"\x0fSERVICE_UNKNOWN\x10\x032\xb6\x01\n" +
	"\x06Health\x12T\n" +
	"\x05Check\x12$.distribkv.health.HealthCheckRequest\x1a%.distribkv.health.HealthCheckResponse\x12V\n" +
	"\x05Watch\x12$.distribkv.health.HealthCheckRequest\x1a%.distribkv.health.HealthCheckResponse0\x01B0Z.github.com/jonandonigv/distribKV/health;healthb\x06proto3"
...
var file_proto_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: distribkv.health.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: distribkv.health.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: distribkv.health.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: distribkv.health.HealthCheckResponse.status:type_name -> distribkv.health.HealthCheckResponse.ServingStatus
	1, // 1: distribkv.health.Health.Check:input_type -> distribkv.health.HealthCheckRequest
	1, // 2: distribkv.health.Health.Watch:input_type -> distribkv.health.HealthCheckRequest
	2, // 3: distribkv.health.Health.Check:output_type -> distribkv.health.HealthCheckResponse
	2, // 4: distribkv.health.Health.Watch:output_type -> distribkv.health.HealthCheckResponse
