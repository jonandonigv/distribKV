...
### 1. FIXED: Blocking Send to applyCh While Holding Mutex
...
### 2. FIXED: AppendEntries Holds Lock During Persist
...
### 3. FIXED: RequestVote Holds Lock During Persist
...
### 6. FIXED: Double Lock Pattern in sendRequestVote
...
### 11. FIXED: Vote Counting Race Condition
