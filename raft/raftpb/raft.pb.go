...
type LogEntry struct {
	...
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // opaque payload; kv.Command serialized by callers
...
type AppendEntriesResponse struct {
	...
	Success       bool                   `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"` // true if follower contained entry matching prev_log
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type InstallSnapshotRequest struct {
	...
	Term              int64                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`                                                      // leader's term
	LeaderId          int32                  `protobuf:"varint,2,opt,name=leader_id,json=leaderId,proto3" json:"leader_id,omitempty"`                              // so follower can redirect clients
	LastIncludedIndex int64                  `protobuf:"varint,3,opt,name=last_included_index,json=lastIncludedIndex,proto3" json:"last_included_index,omitempty"` // snapshot replaces all entries up to here
	...
	Offset            int64                  `protobuf:"varint,5,opt,name=offset,proto3" json:"offset,omitempty"`                                                  // byte offset where chunk begins
	Data              []byte                 `protobuf:"bytes,6,opt,name=data,proto3" json:"data,omitempty"`                                                       // snapshot chunk (single chunk for 0.1.x)
...
const file_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x10proto/raft.proto\x12\x0edistribkv.raft\"N\n" +
	"\bLogEntry\x12\x14\n" +
	...
	"\rprev_log_term\x18\x04 \x01(\x03R\vprevLogTerm\x122\n" +
	"\aentries\x18\x05 \x03(\v2\x18.distribkv.raft.LogEntryR\aentries\x12#\n" +
	"\rleader_commit\x18\x06 \x01(\x03R\fleaderCommit\"E\n" +
	"\x15AppendEntriesResponse\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x03R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\"\xe7\x01\n" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term2\xa0\x02\n" +
	"\x04Raft\x12V\n" +
	"\vRequestVote\x12\".distribkv.raft.RequestVoteRequest\x1a#.distribkv.raft.RequestVoteResponse\x12\\\n" +
	"\rAppendEntries\x12$.distribkv.raft.AppendEntriesRequest\x1a%.distribkv.raft.AppendEntriesResponse\x12b\n" +
	"\x0fInstallSnapshot\x12&.distribkv.raft.InstallSnapshotRequest\x1a'.distribkv.raft.InstallSnapshotResponseB5Z3github.com/jonandonigv/distribKV/raft/raftpb;raftpbb\x06proto3"
...
var file_proto_raft_proto_goTypes = []any{
	(*LogEntry)(nil),                // 0: distribkv.raft.LogEntry
	(*RequestVoteRequest)(nil),      // 1: distribkv.raft.RequestVoteRequest
	(*RequestVoteResponse)(nil),     // 2: distribkv.raft.RequestVoteResponse
	(*AppendEntriesRequest)(nil),    // 3: distribkv.raft.AppendEntriesRequest
	(*AppendEntriesResponse)(nil),   // 4: distribkv.raft.AppendEntriesResponse
	(*InstallSnapshotRequest)(nil),  // 5: distribkv.raft.InstallSnapshotRequest
	(*InstallSnapshotResponse)(nil), // 6: distribkv.raft.InstallSnapshotResponse
}
var file_proto_raft_proto_depIdxs = []int32{
	0, // 0: distribkv.raft.AppendEntriesRequest.entries:type_name -> distribkv.raft.LogEntry
	1, // 1: distribkv.raft.Raft.RequestVote:input_type -> distribkv.raft.RequestVoteRequest
	3, // 2: distribkv.raft.Raft.AppendEntries:input_type -> distribkv.raft.AppendEntriesRequest
	5, // 3: distribkv.raft.Raft.InstallSnapshot:input_type -> distribkv.raft.InstallSnapshotRequest
	2, // 4: distribkv.raft.Raft.RequestVote:output_type -> distribkv.raft.RequestVoteResponse
	4, // 5: distribkv.raft.Raft.AppendEntries:output_type -> distribkv.raft.AppendEntriesResponse
	6, // 6: distribkv.raft.Raft.InstallSnapshot:output_type -> distribkv.raft.InstallSnapshotResponse
