...
// Command is serialized and stored in Raft log
type Command struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Op            OpType                 `protobuf:"varint,1,opt,name=op,proto3,enum=kv.OpType" json:"op,omitempty"`
...
func (x *GetRequest) GetSequenceNum() int64 {
	if x != nil {
		return x.SequenceNum
	}
	return 0
...
func (x *PutRequest) GetSequenceNum() int64 {
	if x != nil {
		return x.SequenceNum
	}
	return 0
...
func (x *AppendRequest) GetClientId() int64 {
	if x != nil {
		return x.ClientId
	}
	return 0
...
func (x *AppendRequest) GetSequenceNum() int64 {
	if x != nil {
		return x.SequenceNum
	}
	return 0
...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\fsequence_num\x18\x04 \x01(\x03R\vsequenceNum\"}\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x1b\n" +
	"\tclient_id\x18\x03 \x01(\x03R\bclientId\x12!\n" +
	"\fsequence_num\x18\x04 \x01(\x03R\vsequenceNum\"\x80\x01\n" +
	...
	"\x0eOP_TYPE_APPEND\x10\x032\x85\x01\n" +
	"\x02KV\x12&\n" +
	"\x03Get\x12\x0e.kv.GetRequest\x1a\x0f.kv.GetResponse\x12&\n" +
	"\x03Put\x12\x0e.kv.PutRequest\x1a\x0f.kv.PutResponse\x12/\n" +
	"\x06Append\x12\x11.kv.AppendRequest\x1a\x12.kv.AppendResponseB+Z)github.com/jonandonigv/distribKV/proto/kvb\x06proto3"
...
var file_proto_kv_proto_goTypes = []any{
	(OpType)(0),            // 0: kv.OpType
	(*Command)(nil),        // 1: kv.Command
	(*GetRequest)(nil),     // 2: kv.GetRequest
	(*GetResponse)(nil),    // 3: kv.GetResponse
	(*PutRequest)(nil),     // 4: kv.PutRequest
	(*PutResponse)(nil),    // 5: kv.PutResponse
	(*AppendRequest)(nil),  // 6: kv.AppendRequest
	(*AppendResponse)(nil), // 7: kv.AppendResponse
}
var file_proto_kv_proto_depIdxs = []int32{
	0, // 0: kv.Command.op:type_name -> kv.OpType
	2, // 1: kv.KV.Get:input_type -> kv.GetRequest
	4, // 2: kv.KV.Put:input_type -> kv.PutRequest
	6, // 3: kv.KV.Append:input_type -> kv.AppendRequest
	3, // 4: kv.KV.Get:output_type -> kv.GetResponse
	5, // 5: kv.KV.Put:output_type -> kv.PutResponse
	7, // 6: kv.KV.Append:output_type -> kv.AppendResponse
